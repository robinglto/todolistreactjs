                 ...
                 <li className="  grid justify-items-center ">
                    ...
                    <span 
                        ...
                        className="p-1 border-solid border-2 border-r-0 rounded-r-none rounded-lg">
                            <img className="w-7 h-7 cursor-pointer	" src="https://img.icons8.com/color/48/000000/checked--v1.png"/>
                    </span>
                   
                    <p  className="sm:w-3/4 p-1 border-solid border-2  border-l-0 rounded-l-none rounded-r-none border-r-0 rounded-lg subpixel-antialiased "> {props.text}</p> 

                    <span 
                        onClick={props.onDelete}>
                            <img className="p-1 w-8 h-10 cursor-pointer border-solid border-2 rounded-l-none border-l-0	 rounded-lg" src="https://img.icons8.com/carbon-copy/100/FA5252/filled-trash.png"/>
                    </span>   
                    </div>
                 </li>   
        </div>
