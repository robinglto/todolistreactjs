    ...
    return (
        <div className="mb-2">
                 <li className="  flex justify-center   ">
                    <div className="flex sm:-space-x-1 sm:w-1/4  w-80 ">
                    <span 
                    ...
                    <p  className={`sm:w-3/4 p-1 border-solid border-2  border-l-0 rounded-l-none rounded-r-none border-r-0 rounded-lg subpixel-antialiased  ${props.completed? "line-through":""} w-72`}> {props.text.length?props.text:""}</p> 
